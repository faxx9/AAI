...
- [**Regression Metrics**](../../M4/lessons/01_slides_regression_metrics.qmd) (where targets are **continuous**):
    - R-squared (default when you call `model.score()`) 
    - Mean Squared Error (MSE) - (also used as a loss function)
    - Mean Absolute Percentage Error (MAPE)
- [**Classification Metrics**](../../M4/lessons/03_slides_classification_metrics.qmd) (where targets are **categorical**):
